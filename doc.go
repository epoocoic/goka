//go:generate go run go.uber.org/mock/mockgen -self_package github.com/epoocoic/goka -package goka -destination mockstorage.go github.com/epoocoic/goka/storage Storage
//go:generate go run go.uber.org/mock/mockgen -self_package github.com/epoocoic/goka -package goka -destination mocks.go github.com/epoocoic/goka TopicManager,Producer,Broker
//go:generate go run go.uber.org/mock/mockgen -self_package github.com/epoocoic/goka -package goka -destination mockssarama.go github.com/IBM/sarama Client,ClusterAdmin
